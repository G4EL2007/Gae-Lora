...
public class Menu {
    ...
    private static void mostrarComunidadUniversitaria() {
        ...
        // Las consultas siguen dentro de los DAO. Aqui solo juntamos los resultados.
        ...
        if (comunidadUniversitaria.isEmpty()) {
            System.out.println("Todavia no hay alumnos ni profesores registrados.");
            return;
        }

        // Polimorfismo: cada objeto ejecuta su propio toString, aunque sea PersonaUT.
    ...
    public static void menu() throws IOException {
        ...
        do {
            ...
            System.out.println("10.- Mostrar Comunidad Universitaria");
            ...
            try {
                ...
                System.out.println("Debes escribir un numero del 1 al 11.");
            }
        } while (opcion != 11);
    }
}
